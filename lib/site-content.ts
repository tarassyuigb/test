...
export const PROJECTS: ProjectData[] = [
  {
    id: "kelowna-estate",
    title: "West Kelowna Residential Estate",
    location: "West Kelowna, BC",
    city: "kelowna",
    category: "residential",
    image: "/images/projects/siding-fibre-cement-9.jpg",
    scope: ["LP SmartSide lap siding", "Longboard aluminum trim", "Continuous seamless gutters", "GutterGlove micro-mesh guard"],
    year: 2024,
    featured: true,
  },
  {
    id: "vernon-strata",
    title: "Vernon Strata Complex",
    location: "Vernon, BC",
    city: "vernon",
    category: "multifamily",
    image: "/images/heroes/multifamily.jpg",
    scope: ["James Hardie fibre cement — 48 units", "Continuous seamless gutters", "Step Code exterior insulation", "Phased occupied-building installation"],
    year: 2023,
    featured: true,
  },
  {
    id: "salmon-arm-commercial",
    title: "Salmon Arm Commercial Building",
    location: "Salmon Arm, BC",
    city: "salmon-arm",
    category: "commercial",
    image: "/images/projects/siding-fibre-cement-1.jpg",
    scope: ["Longboard aluminum facade", "Metal panel rainscreen system", "Commercial eavestroughs and drainage"],
    year: 2024,
    featured: true,
  },
  {
    id: "revelstoke-residence",
    title: "Revelstoke Mountain Residence",
    location: "Revelstoke, BC",
    city: "revelstoke",
    category: "residential",
    image: "/images/projects/siding-fibre-cement-6.jpg",
    scope: ["Cedar siding installation", "GutterGlove IceBreaker heated system", "Snow stops and roof guards", "Step Code compliant envelope"],
    year: 2023,
    featured: false,
  },
  {
    id: "calgary-new-development",
    title: "Calgary New Development Package",
    location: "Calgary, AB",
    city: "calgary",
    category: "residential",
    image: "/images/projects/siding-fibre-cement-3.jpg",
    scope: ["LP SmartSide complete package", "Gentek window and door installation", "Continuous gutters with Alu-Rex", "Soffits, fascia, and trim"],
    year: 2024,
    featured: false,
  },
  {
    id: "kelowna-lowrise",
    title: "Kelowna Low-Rise Apartment",
    location: "Kelowna, BC",
    city: "kelowna",
    category: "multifamily",
    image: "/images/projects/siding-metal-3.jpg",
    scope: ["4-storey building envelope", "James Hardie cladding system", "Step Code exterior insulation", "Commercial gutters throughout"],
    year: 2022,
    featured: false,
  },
  {
    id: "enderby-heritage-reno",
    title: "Enderby Heritage Renovation",
    location: "Enderby, BC",
    city: "enderby",
    category: "renovation",
    image: "/images/projects/siding-fibre-cement-12.jpg",
    scope: ["Full siding replacement", "Gentek window installation", "New fascia and soffits", "Computer-rendered design preview"],
    year: 2023,
    featured: false,
  },
  {
    id: "vernon-custom-home",
    title: "Vernon Custom Home Exterior",
    location: "Vernon, BC",
    city: "vernon",
    category: "residential",
    image: "/images/projects/siding-cedar-3.jpg",
    scope: ["James Hardie HardieShingle", "Metal accent panel system", "Custom downspout fabrication", "Cedar soffit and fascia"],
    year: 2024,
    featured: false,
  },
]

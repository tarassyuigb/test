...
export const metadata: Metadata = {
  ...
  description:
    "Streamline Exteriors serves six locations across BC and Alberta: Kelowna, Vernon, Salmon Arm, Enderby, Revelstoke, and Calgary. Residential and commercial exterior systems in every market.",
  keywords: [
  ...
  openGraph: {
    title: "Locations | Exterior Contractor BC & Alberta | Streamline Exteriors",
    description:
      "Six locations across BC and Alberta — Kelowna, Vernon, Salmon Arm, Enderby, Revelstoke, Calgary. The same installation standard in every market since 1994.",
    type: "website",
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20 xl:px-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-14 items-end">
            <div>
              ...
              <p className="text-white/42 text-[15px] font-light leading-[1.72] tracking-wide max-w-[540px] mb-10">
            ...
            <div className="hidden lg:flex flex-col gap-1">
              {SERVICE_TAGS.map((tag) => (
                <div key={tag} className="flex items-center gap-3 py-2">
                  ...
                  <span className="text-white/35 text-[12px] font-light tracking-wide">{tag}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="border-b border-white/[0.05]">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20 xl:px-28 py-20">
          ...
          <div className="flex items-center gap-4 mb-12">
            ...
            <span className="text-white/20 text-[9px] uppercase tracking-[0.3em]">{bcCities.length} locations</span>
          </div>
            ...
            {bcCities.map((city, i) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4 mb-5">
                  ...
                  <span className="font-mono text-[9px] tracking-[0.24em] text-white/25">BC</span>
                </div>

                <h2
                  className="font-display font-black text-white/70 group-hover:text-white uppercase leading-[0.9] tracking-[-0.01em] mb-4 transition-colors duration-300"
                  style={{ fontSize: "clamp(28px, 3.5vw, 48px)" }}
                >
                  {city.name}
                </h2>

                <p className="text-white/38 text-[12.5px] font-light leading-relaxed tracking-wide mb-6 group-hover:text-white/55 transition-colors duration-300">
      ...
      <section className="border-b border-white/[0.05]">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20 xl:px-28 py-20">
          ...
          <div className="flex items-center gap-4 mb-12">
            ...
            <span className="text-white/20 text-[9px] uppercase tracking-[0.3em]">{abCities.length} locations</span>
          </div>
            ...
            {abCities.map((city, i) => (
              ...
              >
                <div className="flex items-center gap-6 min-w-0">
                  <span className="font-mono text-[10px] tracking-[0.22em] text-white/20 shrink-0 w-6">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="min-w-0">
                    <h2
                      className="font-display font-black text-white/70 group-hover:text-white uppercase leading-none tracking-[-0.01em] transition-colors duration-200"
                ...
                <div className="hidden sm:flex items-center gap-8 shrink-0">
                  <span className="text-[10px] font-medium uppercase tracking-[0.3em] text-white/28 group-hover:text-white/50 transition-colors duration-200">
                    {city.region}
                  </span>
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20 xl:px-28 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 items-start">
            <div>
              ...
              <p className="text-white/42 text-[14.5px] font-light leading-[1.78] tracking-wide mb-5">
              ...
              <p className="text-white/28 text-[13px] font-light leading-[1.78] tracking-wide">
            ...
            <div className="border border-white/[0.06] p-8">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-[9px] uppercase tracking-[0.28em] text-white/20 mb-1.5">Salmon Arm · Revelstoke · Shuswap</p>
                  <a href={BUSINESS.phone.primaryHref} className="text-white/50 text-[14px] font-light tracking-wide hover:text-white transition-colors duration-200">
                    {BUSINESS.phone.primary}
                  </a>
                </div>
                <div className="h-px bg-white/[0.05]" />
                <div>
                  <p className="text-[9px] uppercase tracking-[0.28em] text-white/20 mb-1.5">Vernon · Kelowna · Enderby</p>
                  <a href={BUSINESS.phone.vernonHref} className="text-white/50 text-[14px] font-light tracking-wide hover:text-white transition-colors duration-200">
                    {BUSINESS.phone.vernon}
                  </a>
                </div>
                <div className="h-px bg-white/[0.05]" />
                <div>
                  <p className="text-[9px] uppercase tracking-[0.28em] text-white/20 mb-1.5">Calgary · Alberta</p>
                  <a href={`mailto:${BUSINESS.email}`} className="text-white/50 text-[13px] font-light tracking-wide hover:text-white transition-colors duration-200">
                    {BUSINESS.email}
                  </a>
                </div>
              </div>
      ...
      <section>
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20 xl:px-28 py-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
          <div className="max-w-[520px]">
            ...
            <p className="text-white/38 text-[13.5px] font-light leading-[1.72] tracking-wide">
          ...
          <div className="flex flex-col gap-3 lg:min-w-[240px]">
            ...
            <div className="pt-2 border-t border-white/[0.06]">
              <p className="text-white/20 text-[10px] uppercase tracking-[0.3em] mb-1.5">Or call us directly</p>
              <a href={BUSINESS.phone.primaryHref} className="text-white/40 text-[12px] tracking-wide hover:text-white transition-colors duration-300">
                {BUSINESS.phone.primary}
              </a>
            </div>
          </div>

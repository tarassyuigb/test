...
const COMMERCIAL_FAQ = [
  ...
  },
  {
    ...
    a: "We carry $15M commercial liability insurance and continuous WCB (WorkSafeBC) coverage since 1994. This meets the documentation threshold required by most property managers, strata corporations, and general contractors before exterior work begins. We can provide COI and WCB clearance letters on request.",
  },
  {
...
const SERVICE_SCHEMA = {
  ...
  description:
    "Commercial and multi-family exterior envelope systems in BC and Alberta. Low-rise apartments, strata complexes, and commercial facades. Step Code compliant. $15M liability insured.",
  serviceType: "Commercial Exterior Construction",
  url: "https://www.streamlineexteriors.ca/commercial",
}
...
const PROJECT_TYPES = [
  ...
  },
  {
    ...
    body: "Commercial building facades, strip mall re-cladding, and mixed-use ground-floor commercial. Longboard aluminum, fibre cement, and metal panel systems for demanding commercial applications.",
  },
  {
    ...
    <main className="bg-black min-h-screen">
      ...
      <section className="relative pt-40 pb-24 border-b border-white/[0.05] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('/images/heroes/commercial.jpg')",
      ...
      <PhotoShowcase photos={[
        { src: "/images/heroes/commercial.jpg", label: "Commercial", caption: "Fairfield by Marriott · Salmon Arm, BC" },
        { src: "/images/projects/siding-fibre-cement-1.jpg", label: "Commercial · BC Interior" },
                ...
                <ul className="space-y-3">
                  {CREDENTIALS.map((c, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-[3px] h-[3px] rounded-full bg-[#14008B] mt-[7px] shrink-0" />
                      <span className="text-white/35 text-[11.5px] font-light leading-relaxed tracking-wide">
                        {c}
                      </span>
                    </li>
                  ))}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
              ...
              <p className="text-white/35 text-[11.5px] font-light tracking-wide">
                $15M insured · Step Code certified · Free estimate · BC & Alberta
              </p>
            </div>
      ...
      <FAQGrid items={COMMERCIAL_FAQ} label="Project Questions" />
        ...
        <FadeIn className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
          <div className="max-w-[560px]">
            ...
            <p className="text-white/40 text-[14px] font-light leading-[1.72] tracking-wide">
              Early contractor involvement on commercial and multi-family projects reduces specification risk and keeps envelope scopes on budget.
            </p>
          </div>
